# FreshSaver Hackathon Deck

The editable presentation is:
...
The source is `scripts/generate-deck.mjs`. Review the generated deck in PowerPoint
or Google Slides before presenting because font substitution can vary by platform.
