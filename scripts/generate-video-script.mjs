...
const scenes = [
  ...
  },
  {
    time: '02:20–03:12',
    duration: 52,
    criterion: 'Role of AI and live demonstration',
  ...
  },
  {
    ...
    narration: 'Every recommendation shows where it came from. The owner can inspect the predicted range, clearance probability, expected margin, top model factors, model version, and whether generation used Gemini or the fallback. The recommendation remains pending until the owner approves or rejects it. Approval publishes the price, records the reviewer, and activates matching shoppers.',
    overlay: 'No black box • no silent price change',
  },
  {
    time: '03:48–04:15',
    duration: 27,
    criterion: 'Customer outcome',
    screen: `${LIVE}/deals\nThen ${LIVE}/auth/login and ${LIVE}/account`,
    ...
    narration: 'Approved offers appear in the customer marketplace with the store, current price, stock, and pickup context. The cart is restricted to one store, and checkout re-reads price and availability from the database. Customers can then see their store-scoped order history.',
...
const preflight = [
  ...
  `Open the deck at Slide 1, plus browser tabs for ${LIVE}/, /login, /dashboard, /dashboard/products, /dashboard/customers, /dashboard/pricing, /deals, /auth/login, and /account.`,
