...
const scenes = [
  ...
  },
  {
    ...
    screen: `PowerPoint: ${DECK}\nSlide 6 — “Two AIs. Two jobs. One controlled decision.”`,
  ...
  },
  {
    ...
    screen: `PowerPoint: ${DECK}\nSlide 9 — “Pilot, learn, integrate, then scale.”`,
...
const preflight = [
  ...
  `Open the deck at Slides 1, 2, 6 and 9, plus browser tabs for ${LIVE}/, /login, /dashboard, /dashboard/products, /dashboard/customers, /dashboard/pricing, /deals, /auth/login, and /account.`,
